...
public class ShowRecordActy extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.acty_showrecord);
	...
	class MediaCompletion implements OnCompletionListener {
		...
		public void onCompletion(MediaPlayer mp) {
			...
			ad_left.stop();
			ad_right.stop();
			Toast.makeText(ShowRecordActy.this, "播放完毕", Toast.LENGTH_SHORT).show();
			tv_recordTime.setText("00:00:00");
		}
	}
}
